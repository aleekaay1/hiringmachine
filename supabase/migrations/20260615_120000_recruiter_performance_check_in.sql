-- Mid-week performance check-in invites + recruiter coaching form submissions.
...
comment on table public.recruiter_performance_check_in_invites is
  'Mid-week coaching invite emails for staff below 50% pace (Fri–Thu week).';
comment on table public.recruiter_performance_check_ins is
  'Recruiter / leadership mid-week performance coaching form submissions.';
