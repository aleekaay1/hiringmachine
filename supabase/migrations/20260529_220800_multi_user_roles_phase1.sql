-- Phase 1: multi-user roles, recruiter scoping readiness, and points scaffolding.
...
-- Example:
-- insert into public.user_profile_hierarchy (leader_user_id, member_user_id, relationship_role)
-- values ('<lead_user_uuid>', '<member_user_uuid>', 'mga');
