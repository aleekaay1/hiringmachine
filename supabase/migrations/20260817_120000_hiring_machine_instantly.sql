-- Hiring Machine: Instantly-led CRM (clone project only).
...
comment on table public.hm_people is 'Hiring Machine people sourced from Instantly replies.';
comment on table public.hm_instantly_events is 'Raw Instantly webhook events.';
comment on table public.hm_email_sends is 'Instantly thread replies we send (shortlisted / AO Hub).';
comment on table public.hm_metrics_cache is 'Cached Instantly campaign analytics for Home.';
