-- Run in Supabase SQL Editor for fast Webinar Questionnaire awaiting board.
-- Returns a small showed-attendee index from the WG dashboard snapshot (server-side),
-- instead of downloading the full subscriptions JSON to the browser.
