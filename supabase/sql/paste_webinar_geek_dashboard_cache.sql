-- Paste in Supabase SQL editor (same as migration 20260515_120000_webinar_geek_dashboard_cache.sql).
...
drop policy if exists "authenticated update webinar geek dashboard cache" on public.webinar_geek_dashboard_snapshots;
