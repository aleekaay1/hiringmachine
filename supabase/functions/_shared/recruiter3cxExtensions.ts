/**
 * Hardcoded recruiter extension map — portal emails only (must match user_profiles.email).
 * Sync via Call log → "Sync extensions" or threecx-call-admin sync-extensions.
 */
...
/** Portal users matched to 3CX extensions (non-portal 3CX users omitted). */
